  ...
  <div class="flex-1 container mx-auto px-4 sm:px-6 py-12 sm:py-20 max-w-5xl">
    ...
    <div class="text-center mb-12 sm:mb-16">
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <!-- Windows Card -->
        <div class="group relative bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-xl hover:shadow-2xl hover:scale-[1.02] transition-all duration-300">
          ...
          <h3 class="text-xl font-bold mb-4">Windows</h3>
          ...
          <div class="space-y-2">
            <a
              ...
              :key="asset.url"
              :href="asset.url"
              class="flex items-center justify-between gap-2 bg-white/20 hover:bg-white/30 rounded-lg px-3 py-2 text-sm transition-colors"
            >
              <div class="flex items-center gap-2">
                <Download class="w-4 h-4" />
                <span>{{ asset.name }}</span>
              </div>
              <span class="text-white/70 text-xs">{{ asset.size }}</span>
            </a>
            <div v-if="downloads.windows.length === 0" class="text-white/70 text-sm py-2">
        ...
        <!-- macOS Card -->
        <div class="group relative bg-gradient-to-br from-neutral-700 to-neutral-800 rounded-2xl p-6 text-white shadow-xl hover:shadow-2xl hover:scale-[1.02] transition-all duration-300">
          <div class="absolute inset-0 bg-white/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
          ...
          <h3 class="text-xl font-bold mb-4">macOS</h3>
          ...
          <div class="space-y-2">
            ...
            <div v-if="downloads.macos.length === 0" class="text-white/70 text-sm py-2">
              Keine Downloads verfügbar
            </div>
          </div>
        </div>
        ...
        <!-- Linux Card -->
        <div class="group relative bg-gradient-to-br from-amber-500 to-orange-500 rounded-2xl p-6 text-white shadow-xl hover:shadow-2xl hover:scale-[1.02] transition-all duration-300">
          <div class="absolute inset-0 bg-white/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
          ...
          <h3 class="text-xl font-bold mb-4">Linux</h3>
          ...
          <div class="space-y-2">
            ...
            <div v-if="downloads.linux.length === 0" class="text-white/70 text-sm py-2">
              Keine Downloads verfügbar
            </div>
          </div>
        </div>
